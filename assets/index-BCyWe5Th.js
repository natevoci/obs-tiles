...
var q$4 = 60109, r$4 = 60110, t$1 = 60112;
...
C$2.prototype.setState = function(a, b2) {
...
function J$1(a, b2, c2) {
  ...
  if (null != b2) for (e2 in void 0 !== b2.ref && (h2 = b2.ref), void 0 !== b2.key && (k2 = "" + b2.key), b2) H$3.call(b2, e2) && !I$3.hasOwnProperty(e2) && (d2[e2] = b2[e2]);
  var g2 = arguments.length - 2;
  if (1 === g2) d2.children = c2;
  else if (1 < g2) {
    for (var f2 = Array(g2), m2 = 0; m2 < g2; m2++) f2[m2] = arguments[m2 + 2];
    d2.children = f2;
  }
  if (a && a.defaultProps) for (e2 in g2 = a.defaultProps, g2) void 0 === d2[e2] && (d2[e2] = g2[e2]);
  return { $$typeof: n$3, type: a, key: k2, ref: h2, props: d2, _owner: G$3.current };
}
function K$1(a, b2) {
...
function O$1(a, b2, c2, e2, d2) {
  ...
  if (h2) return h2 = a, d2 = d2(h2), a = "" === e2 ? "." + N$2(h2, 0) : e2, Array.isArray(d2) ? (c2 = "", null != a && (c2 = a.replace(M$2, "$&/") + "/"), O$1(d2, b2, c2, "", function(a2) {
    return a2;
  })) : null != d2 && (L$1(d2) && (d2 = K$1(d2, c2 + (!d2.key || h2 && h2.key === d2.key ? "" : ("" + d2.key).replace(M$2, "$&/") + "/") + a)), b2.push(d2)), 1;
  h2 = 0;
  e2 = "" === e2 ? "." : e2 + ":";
  ...
  else if (f2 = y$4(a), "function" === typeof f2) for (a = f2.call(a), g2 = 0; !(k2 = a.next()).done; ) k2 = k2.value, f2 = e2 + N$2(k2, g2++), h2 += O$1(k2, b2, c2, f2, d2);
  else if ("object" === k2) throw b2 = "" + a, Error(z$3(31, "[object Object]" === b2 ? "object with keys {" + Object.keys(a).join(", ") + "}" : b2));
  return h2;
}
...
react_production_min.cloneElement = function(a, b2, c2) {
  ...
  if (null != b2) {
    ...
    for (f2 in b2) H$3.call(b2, f2) && !I$3.hasOwnProperty(f2) && (e2[f2] = void 0 === b2[f2] && void 0 !== g2 ? g2[f2] : b2[f2]);
  }
  var f2 = arguments.length - 2;
  if (1 === f2) e2.children = c2;
  else if (1 < f2) {
    g2 = Array(f2);
...
react_production_min.lazy = function(a) {
  return { $$typeof: v$3, _payload: { _status: -1, _result: a }, _init: Q$1 };
};
react_production_min.memo = function(a, b2) {
  return { $$typeof: u$1, type: a, compare: void 0 === b2 ? null : b2 };
};
react_production_min.useCallback = function(a, b2) {
  return S$2().useCallback(a, b2);
};
react_production_min.useContext = function(a, b2) {
  return S$2().useContext(a, b2);
};
react_production_min.useDebugValue = function() {
};
react_production_min.useEffect = function(a, b2) {
  return S$2().useEffect(a, b2);
};
react_production_min.useImperativeHandle = function(a, b2, c2) {
  return S$2().useImperativeHandle(a, b2, c2);
};
react_production_min.useLayoutEffect = function(a, b2) {
  return S$2().useLayoutEffect(a, b2);
};
react_production_min.useMemo = function(a, b2) {
  return S$2().useMemo(a, b2);
};
react_production_min.useReducer = function(a, b2, c2) {
  return S$2().useReducer(a, b2, c2);
};
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$2 = reactExports, g$3 = 60103;
reactJsxRuntime_production_min.Fragment = 60107;
if ("function" === typeof Symbol && Symbol.for) {
  var h$2 = Symbol.for;
  g$3 = h$2("react.element");
  reactJsxRuntime_production_min.Fragment = h$2("react.fragment");
}
var m$4 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, n$2 = Object.prototype.hasOwnProperty, p$2 = { key: true, ref: true, __self: true, __source: true };
function q$3(c2, a, k2) {
  var b2, d2 = {}, e2 = null, l2 = null;
  void 0 !== k2 && (e2 = "" + k2);
  void 0 !== a.key && (e2 = "" + a.key);
  void 0 !== a.ref && (l2 = a.ref);
  for (b2 in a) n$2.call(a, b2) && !p$2.hasOwnProperty(b2) && (d2[b2] = a[b2]);
...
(function(exports$1) {
  ...
  if ("undefined" === typeof window || "function" !== typeof MessageChannel) {
    ...
    k2 = exports$1.unstable_forceFrameRate = function() {
    };
  } else {
    ...
    exports$1.unstable_shouldYield = function() {
      return exports$1.unstable_now() >= E2;
    };
    k2 = function() {
    };
  ...
  function V2(a, b2) {
    ...
    try {
      T2(b2);
      for (O2 = J2(L2); null !== O2 && (!(O2.expirationTime > b2) || a && !exports$1.unstable_shouldYield()); ) {
        var d2 = O2.callback;
  ...
  exports$1.unstable_requestPaint = W2;
...
function ea(a, b2) {
  ca[a] = b2;
  for (a = 0; a < b2.length; a++) ba.add(b2[a]);
}
...
function na(a, b2, c2, d2) {
  if (null === b2 || "undefined" === typeof b2 || ma(a, b2, c2, d2)) return true;
  if (d2) return false;
...
function B$2(a, b2, c2, d2, e2, f2, g2) {
...
"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(a) {
  D$2[a] = new B$2(a, 0, false, a, null, false, false);
});
[["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(a) {
  var b2 = a[0];
  D$2[b2] = new B$2(b2, 1, false, a[1], null, false, false);
});
["contentEditable", "draggable", "spellCheck", "value"].forEach(function(a) {
  D$2[a] = new B$2(a, 2, false, a.toLowerCase(), null, false, false);
});
["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(function(a) {
  D$2[a] = new B$2(a, 2, false, a, null, false, false);
});
"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(a) {
  D$2[a] = new B$2(a, 3, false, a.toLowerCase(), null, false, false);
});
["checked", "multiple", "muted", "selected"].forEach(function(a) {
  D$2[a] = new B$2(a, 3, true, a, null, false, false);
});
["capture", "download"].forEach(function(a) {
  D$2[a] = new B$2(a, 4, false, a, null, false, false);
});
["cols", "rows", "size", "span"].forEach(function(a) {
  D$2[a] = new B$2(a, 6, false, a, null, false, false);
});
["rowSpan", "start"].forEach(function(a) {
  D$2[a] = new B$2(a, 5, false, a.toLowerCase(), null, false, false);
});
var oa = /[\-:]([a-z])/g;
function pa(a) {
...
"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(a) {
  ...
  D$2[b2] = new B$2(b2, 1, false, a, null, false, false);
});
"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(a) {
  var b2 = a.replace(oa, pa);
  D$2[b2] = new B$2(b2, 1, false, a, "http://www.w3.org/1999/xlink", false, false);
});
["xml:base", "xml:lang", "xml:space"].forEach(function(a) {
  var b2 = a.replace(oa, pa);
  D$2[b2] = new B$2(b2, 1, false, a, "http://www.w3.org/XML/1998/namespace", false, false);
});
["tabIndex", "crossOrigin"].forEach(function(a) {
  D$2[a] = new B$2(a, 1, false, a.toLowerCase(), null, false, false);
});
D$2.xlinkHref = new B$2("xlinkHref", 1, false, "xlink:href", "http://www.w3.org/1999/xlink", true, false);
["src", "href", "action", "formAction"].forEach(function(a) {
  D$2[a] = new B$2(a, 1, false, a.toLowerCase(), null, true, true);
});
  ...
  try {
    ...
    if (k2 && d2 && "string" === typeof k2.stack) {
      ...
      for (; 1 <= g2 && 0 <= h2; g2--, h2--) if (e2[g2] !== f2[h2]) {
        if (1 !== g2 || 1 !== h2) {
          do
            if (g2--, h2--, 0 > h2 || e2[g2] !== f2[h2]) return "\n" + e2[g2].replace(" at new ", " at ");
          while (1 <= g2 && 0 <= h2);
        }
        break;
      }
...
function eb(a, b2) {
  ...
  if (b2 = db(b2.children)) a.children = b2;
  return a;
}
...
function gb(a, b2) {
  if (null != b2.dangerouslySetInnerHTML) throw Error(y$3(91));
...
function hb(a, b2) {
  ...
  if (null == c2) {
    ...
    b2 = b2.defaultValue;
    if (null != c2) {
      if (null != b2) throw Error(y$3(92));
      if (Array.isArray(c2)) {
        if (!(1 >= c2.length)) throw Error(y$3(93));
        c2 = c2[0];
      }
      b2 = c2;
    }
...
var nb, ob = function(a) {
  ...
  if (a.namespaceURI !== kb.svg || "innerHTML" in a) a.innerHTML = b2;
  else {
    nb = nb || document.createElement("div");
    nb.innerHTML = "<svg>" + b2.valueOf().toString() + "</svg>";
    for (b2 = nb.firstChild; a.firstChild; ) a.removeChild(a.firstChild);
...
function vb(a, b2) {
  if (b2) {
    if (ub[a] && (null != b2.children || null != b2.dangerouslySetInnerHTML)) throw Error(y$3(137, a));
    if (null != b2.dangerouslySetInnerHTML) {
      if (null != b2.children) throw Error(y$3(60));
      if (!("object" === typeof b2.dangerouslySetInnerHTML && "__html" in b2.dangerouslySetInnerHTML)) throw Error(y$3(61));
    }
    if (null != b2.style && "object" !== typeof b2.style) throw Error(y$3(62));
  }
}
function wb(a, b2) {
...
function Ob(a, b2) {
  ...
  if (a) return null;
  if (c2 && "function" !== typeof c2) throw Error(y$3(231, b2, typeof c2));
  return c2;
}
var Pb = false;
if (fa) try {
...
function bc(a) {
  ...
  if (!b2) {
    b2 = Zb(a);
    if (null === b2) throw Error(y$3(188));
    return b2 !== a ? null : a;
  }
  for (var c2 = a, d2 = b2; ; ) {
    var e2 = c2.return;
    ...
    if (e2.child === f2.child) {
      for (f2 = e2.child; f2; ) {
        if (f2 === c2) return ac(e2), a;
        if (f2 === d2) return ac(e2), b2;
        f2 = f2.sibling;
      }
      throw Error(y$3(188));
    }
    if (c2.return !== d2.return) c2 = e2, d2 = f2;
      ...
      if (!g2) {
        ...
        if (!g2) throw Error(y$3(189));
      }
    }
    if (c2.alternate !== d2) throw Error(y$3(190));
  }
  if (3 !== c2.tag) throw Error(y$3(188));
...
function tc(a, b2, c2, d2, e2, f2) {
  if (null === a || a.nativeEvent !== f2) return a = rc(b2, c2, d2, e2, f2), null !== b2 && (b2 = Cb(b2), null !== b2 && fc(b2)), a;
...
function xc(a) {
  ...
  for (var b2 = a.targetContainers; 0 < b2.length; ) {
    ...
    if (null !== c2) return b2 = Cb(c2), null !== b2 && fc(b2), a.blockedOn = c2, false;
    b2.shift();
  }
  return true;
}
...
function Cc(a) {
  ...
  for (; 0 < pc.length && (c2 = pc[0], null === c2.blockedOn); ) vc(c2), null === c2.blockedOn && pc.shift();
}
function Dc(a, b2) {
  var c2 = {};
...
function Hc(a) {
  ...
  if (!Ec[a]) return a;
  var b2 = Ec[a], c2;
  for (c2 in b2) if (b2.hasOwnProperty(c2) && c2 in Gc) return Fc[a] = b2[c2];
  return a;
}
...
function Uc(a, b2) {
  ...
  b2 = a.entangledLanes;
  if (0 !== b2) for (a = a.entanglements, b2 &= d2; 0 < b2; ) c2 = 31 - Vc(b2), e2 = 1 << c2, d2 |= a[c2], b2 &= ~e2;
  return d2;
}
function Wc(a) {
...
function hd(a, b2, c2, d2) {
  if (fd) {
    var e2;
    if ((e2 = 0 === (b2 & 4)) && 0 < jc.length && -1 < qc.indexOf(a)) a = rc(null, a, b2, c2, d2), jc.push(a);
    else {
      var f2 = yc(a, b2, c2, d2);
      if (null === f2) e2 && sc(a, d2);
      else {
        if (e2) {
          if (-1 < qc.indexOf(a)) {
            a = rc(f2, a, b2, c2, d2);
...
function Je(a, b2) {
  ...
  for (d2 = 0; d2 < c2.length; d2++) if (!Ie.call(b2, c2[d2]) || !He(a[c2[d2]], b2[c2[d2]])) return false;
  return true;
}
function Ke(a) {
...
function Me$1(a, b2) {
  return a && b2 ? a === b2 ? true : a && 3 === a.nodeType ? false : b2 && 3 === b2.nodeType ? Me$1(a, b2.parentNode) : "contains" in a ? a.contains(b2) : a.compareDocumentPosition ? !!(a.compareDocumentPosition(b2) & 16) : false : false;
}
function Ne$1() {
  ...
  Nb(function() {
    ...
    if (0 === (b2 & 7)) {
      a: {
        ...
        if (h3 && 0 === (b2 & 16) && (x2 = c2.relatedTarget || c2.fromElement) && (wc(x2) || x2[ff])) break a;
        if (k3 || h3) {
          h3 = e3.window === e3 ? e3 : (h3 = e3.ownerDocument) ? h3.defaultView || h3.parentWindow : window;
          if (k3) {
            if (x2 = c2.relatedTarget || c2.toElement, k3 = d3, x2 = x2 ? wc(x2) : null, null !== x2 && (z2 = Zb(x2), x2 !== z2 || 5 !== x2.tag && 6 !== x2.tag)) x2 = null;
          } else k3 = null, x2 = d3;
          if (k3 !== x2) {
            w2 = Bd;
            v2 = "onMouseLeave";
            ...
            if (k3 && x2) b: {
              ...
              u2 = x2;
              t2 = 0;
              for (q2 = w2; q2; q2 = gf(q2)) t2++;
              q2 = 0;
              for (v2 = u2; v2; v2 = gf(v2)) q2++;
              for (; 0 < t2 - q2; ) w2 = gf(w2), t2--;
              for (; 0 < q2 - t2; ) u2 = gf(u2), q2--;
              for (; t2--; ) {
                if (w2 === u2 || null !== u2 && w2 === u2.alternate) break b;
                w2 = gf(w2);
                u2 = gf(u2);
              }
              w2 = null;
      ...
      a: {
        ...
        if ("select" === k3 || "input" === k3 && "file" === h3.type) var J2 = ve$1;
        else if (me(h3)) if (we$1) J2 = Fe$1;
        else {
          J2 = De$1;
          var K2 = Ce;
        }
        else (k3 = h3.nodeName) && "input" === k3.toLowerCase() && ("checkbox" === h3.type || "radio" === h3.type) && (J2 = Ee$1);
        if (J2 && (J2 = J2(a, d3))) {
          ne$1(g3, J2, c2, e3);
          break a;
        }
      ...
      switch (a) {
        case "focusin":
          if (me(K2) || "true" === K2.contentEditable) Qe = K2, Re$1 = d3, Se$1 = null;
          break;
        case "focusout":
          Se$1 = Re$1 = Qe = null;
          break;
      ...
      else ie$1 ? ge$1(a, c2) && (L2 = "onCompositionEnd") : "keydown" === a && 229 === c2.keyCode && (L2 = "onCompositionStart");
      L2 && (de$1 && "ko" !== c2.locale && (ie$1 || "onCompositionStart" !== L2 ? "onCompositionEnd" === L2 && ie$1 && (Q2 = nd()) : (kd = e3, ld = "value" in kd ? kd.value : kd.textContent, ie$1 = true)), K2 = oe$1(d3, L2), 0 < K2.length && (L2 = new Ld(L2, a, null, c2, e3), g3.push({ event: L2, listeners: K2 }), Q2 ? L2.data = Q2 : (Q2 = he$1(c2), null !== Q2 && (L2.data = Q2))));
      if (Q2 = ce$1 ? je$1(a, c2) : ke$1(a, c2)) d3 = oe$1(d3, "onBeforeInput"), 0 < d3.length && (e3 = new Ld(
        "onBeforeInput",
        "beforeinput",
        null,
        c2,
...
function wc(a) {
  ...
  for (var c2 = a.parentNode; c2; ) {
    if (b2 = c2[ff] || c2[wf]) {
      c2 = b2.alternate;
      if (null !== b2.child || null !== c2 && null !== c2.child) for (a = sf(a); null !== a; ) {
        if (c2 = a[wf]) return c2;
        a = sf(a);
      }
      return b2;
    }
...
function If(a, b2, c2) {
  ...
  for (var e2 in d2) if (!(e2 in a)) throw Error(y$3(108, Ra(b2) || "Unknown", e2));
  return m$3({}, c2, d2);
}
function Jf(a) {
...
function Kf(a, b2, c2) {
  var d2 = a.stateNode;
  if (!d2) throw Error(y$3(169));
  c2 ? (a = If(a, b2, Df), d2.__reactInternalMemoizedMergedChildContext = a, H$2(N$1), H$2(M$1), I$2(M$1, a)) : H$2(N$1);
  I$2(N$1, c2);
}
...
function sg(a, b2) {
  for (; null !== a; ) {
    var c2 = a.alternate;
    if ((a.childLanes & b2) === b2) if (null === c2 || (c2.childLanes & b2) === b2) break;
    else c2.childLanes |= b2;
    else a.childLanes |= b2, null !== c2 && (c2.childLanes |= b2);
    a = a.return;
  }
}
function tg(a, b2) {
...
function vg(a, b2) {
  if (pg !== a && false !== b2 && 0 !== b2) {
    if ("number" !== typeof b2 || 1073741823 === b2) pg = a, b2 = 1073741823;
...
function Cg(a, b2, c2, d2) {
  ...
  if (null !== f2) {
    ...
    do {
      ...
      } else p2 = { eventTime: p2, lane: h2, tag: f2.tag, payload: f2.payload, callback: f2.callback, next: null }, null === n2 ? (l2 = n2 = p2, k2 = A2) : n2 = n2.next = p2, g2 |= h2;
      f2 = f2.next;
      if (null === f2) if (h2 = e2.shared.pending, null === h2) break;
      else f2 = h2.next, h2.next = null, e2.lastBaseUpdate = h2, e2.shared.pending = null;
    } while (1);
    null === n2 && (k2 = A2);
    e2.baseState = k2;
...
function Eg(a, b2, c2) {
  ...
  if (null !== a) for (b2 = 0; b2 < a.length; b2++) {
    ...
    if (null !== e2) {
      d2.callback = null;
      d2 = c2;
      if ("function" !== typeof e2) throw Error(y$3(191, e2));
      e2.call(d2);
    }
  }
}
...
function Mg(a, b2, c2) {
  ...
  "object" === typeof f2 && null !== f2 ? f2 = vg(f2) : (e2 = Ff(b2) ? Df : M$1.current, d2 = b2.contextTypes, f2 = (d2 = null !== d2 && void 0 !== d2) ? Ef(a, e2) : Cf);
  b2 = new b2(c2, f2);
...
function Og(a, b2, c2, d2) {
  ...
  xg(a);
  var f2 = b2.contextType;
  "object" === typeof f2 && null !== f2 ? e2.context = vg(f2) : (f2 = Ff(b2) ? Df : M$1.current, e2.context = Ef(a, f2));
  Cg(a, c2, e2, d2);
  e2.state = a.memoizedState;
...
function Qg(a, b2, c2) {
  ...
  if (null !== a && "function" !== typeof a && "object" !== typeof a) {
    if (c2._owner) {
      c2 = c2._owner;
      if (c2) {
        if (1 !== c2.tag) throw Error(y$3(309));
        var d2 = c2.stateNode;
      }
      if (!d2) throw Error(y$3(147, a));
      var e2 = "" + a;
    ...
    if (!c2._owner) throw Error(y$3(290, a));
  }
  return a;
}
function Rg(a, b2) {
  if ("textarea" !== a.type) throw Error(y$3(31, "[object Object]" === Object.prototype.toString.call(b2) ? "object with keys {" + Object.keys(b2).join(", ") + "}" : b2));
}
function Sg(a) {
  function b2(b3, c3) {
    if (a) {
  ...
  function h2(a2, b3, c3, d3) {
    if (null === b3 || 6 !== b3.tag) return b3 = Ug(c3, a2.mode, d3), b3.return = a2, b3;
    b3 = e2(b3, c3);
    b3.return = a2;
    return b3;
  }
  function k2(a2, b3, c3, d3) {
    if (null !== b3 && b3.elementType === c3.type) return d3 = e2(b3, c3.props), d3.ref = Qg(a2, b3, c3), d3.return = a2, d3;
  ...
  function l2(a2, b3, c3, d3) {
    if (null === b3 || 4 !== b3.tag || b3.stateNode.containerInfo !== c3.containerInfo || b3.stateNode.implementation !== c3.implementation) return b3 = Wg(c3, a2.mode, d3), b3.return = a2, b3;
    b3 = e2(b3, c3.children || []);
    b3.return = a2;
    return b3;
  }
  function n2(a2, b3, c3, d3, f3) {
    if (null === b3 || 7 !== b3.tag) return b3 = Xg(c3, a2.mode, d3, f3), b3.return = a2, b3;
    b3 = e2(b3, c3);
    b3.return = a2;
    return b3;
  }
  function A2(a2, b3, c3) {
    if ("string" === typeof b3 || "number" === typeof b3) return b3 = Ug("" + b3, a2.mode, c3), b3.return = a2, b3;
  ...
  function p2(a2, b3, c3, d3) {
    ...
    if ("object" === typeof c3 && null !== c3) {
      ...
      if (Pg(c3) || La(c3)) return null !== e3 ? null : n2(a2, b3, c3, d3, null);
      Rg(a2, c3);
    }
    return null;
  }
  function C2(a2, b3, c3, d3, e3) {
    ...
    if ("object" === typeof d3 && null !== d3) {
      ...
      if (Pg(d3) || La(d3)) return a2 = a2.get(c3) || null, n2(b3, a2, d3, e3, null);
      Rg(b3, d3);
    }
    return null;
  }
  function x2(e3, g3, h3, k3) {
    ...
    if (z2 === h3.length) return c2(e3, u2), l3;
    if (null === u2) {
      for (; z2 < h3.length; z2++) u2 = A2(e3, h3[z2], k3), null !== u2 && (g3 = f2(u2, g3, z2), null === t2 ? l3 = u2 : t2.sibling = u2, t2 = u2);
      return l3;
    }
    for (u2 = d2(e3, u2); z2 < h3.length; z2++) q2 = C2(u2, e3, z2, h3[z2], k3), null !== q2 && (a && null !== q2.alternate && u2.delete(null === q2.key ? z2 : q2.key), g3 = f2(q2, g3, z2), null === t2 ? l3 = q2 : t2.sibling = q2, t2 = q2);
  ...
  function w2(e3, g3, h3, k3) {
    var l3 = La(h3);
    if ("function" !== typeof l3) throw Error(y$3(150));
    h3 = l3.call(h3);
    if (null == h3) throw Error(y$3(151));
    ...
    if (n3.done) return c2(e3, u2), l3;
    if (null === u2) {
      for (; !n3.done; z2++, n3 = h3.next()) n3 = A2(e3, n3.value, k3), null !== n3 && (g3 = f2(n3, g3, z2), null === t2 ? l3 = n3 : t2.sibling = n3, t2 = n3);
      return l3;
    }
    for (u2 = d2(e3, u2); !n3.done; z2++, n3 = h3.next()) n3 = C2(u2, e3, z2, n3.value, k3), null !== n3 && (a && null !== n3.alternate && u2.delete(null === n3.key ? z2 : n3.key), g3 = f2(n3, g3, z2), null === t2 ? l3 = n3 : t2.sibling = n3, t2 = n3);
    a && u2.forEach(function(a2) {
      return b2(e3, a2);
    });
    return l3;
  ...
  return function(a2, d3, f3, h3) {
    ...
    if ("string" === typeof f3 || "number" === typeof f3) return f3 = "" + f3, null !== d3 && 6 === d3.tag ? (c2(a2, d3.sibling), d3 = e2(d3, f3), d3.return = a2, a2 = d3) : (c2(a2, d3), d3 = Ug(f3, a2.mode, h3), d3.return = a2, a2 = d3), g2(a2);
    if (Pg(f3)) return x2(a2, d3, f3, h3);
    if (La(f3)) return w2(a2, d3, f3, h3);
    l3 && Rg(a2, f3);
...
function rh(a) {
  ...
  var b2 = a.type;
  if (5 !== a.tag || "head" !== b2 && "body" !== b2 && !nf(b2, a.memoizedProps)) for (b2 = kh; b2; ) mh(a, b2), b2 = rf(b2.nextSibling);
  qh(a);
  if (13 === a.tag) {
    a = a.memoizedState;
...
var vh = ra.ReactCurrentDispatcher, wh = ra.ReactCurrentBatchConfig, xh = 0, R = null, S$1 = null, T$1 = null, yh = false, zh = false;
function Ah() {
  throw Error(y$3(321));
}
function Bh(a, b2) {
...
function Ih() {
  ...
  if (null !== b2) T$1 = b2, S$1 = a;
  else {
    if (null === a) throw Error(y$3(310));
    S$1 = a;
    a = { memoizedState: S$1.memoizedState, baseState: S$1.baseState, baseQueue: S$1.baseQueue, queue: S$1.queue, next: null };
    null === T$1 ? R.memoizedState = T$1 = a : T$1 = T$1.next = a;
  }
  return T$1;
}
...
function Kh(a) {
  ...
  if (null === c2) throw Error(y$3(311));
  ...
  if (null !== e2) {
    ...
    do {
      var l2 = k2.lane;
      if ((xh & l2) === l2) null !== h2 && (h2 = h2.next = { lane: 0, action: k2.action, eagerReducer: k2.eagerReducer, eagerState: k2.eagerState, next: null }), d2 = k2.eagerReducer === a ? k2.eagerState : a(d2, k2.action);
      else {
        var n2 = {
          lane: l2,
          action: k2.action,
...
function Mh(a, b2, c2) {
  ...
  if (null !== e2) a = e2 === d2;
  else if (a = a.mutableReadLanes, a = (xh & a) === a) b2._workInProgressVersionPrimary = d2, th.push(b2);
  if (a) return c2(b2._source);
  th.push(b2);
  throw Error(y$3(350));
}
function Nh(a, b2, c2, d2) {
  var e2 = U$1;
  if (null === e2) throw Error(y$3(349));
...
function bi(a, b2) {
  ...
  if (null !== d2 && null !== b2 && Bh(b2, d2[1])) return d2[0];
...
function Oh(a, b2, c2) {
  ...
  if (a === R || null !== g2 && g2 === R) zh = yh = true;
    ...
    if (0 === a.lanes && (null === g2 || 0 === g2.lanes) && (g2 = b2.lastRenderedReducer, null !== g2)) try {
...
function gi(a, b2, c2, d2, e2) {
  ...
  if (null !== a && !ug) return b2.updateQueue = a.updateQueue, b2.flags &= -517, a.lanes &= ~e2, hi(a, b2, e2);
  b2.flags |= 1;
  fi(a, b2, d2, e2);
  return b2.child;
}
function ii(a, b2, c2, d2, e2, f2) {
  if (null === a) {
    var g2 = c2.type;
    if ("function" === typeof g2 && !ji(g2) && void 0 === g2.defaultProps && null === c2.compare && void 0 === c2.defaultProps) return b2.tag = 15, b2.type = g2, ki(a, b2, g2, d2, e2, f2);
  ...
  g2 = a.child;
  if (0 === (e2 & f2) && (e2 = g2.memoizedProps, c2 = c2.compare, c2 = null !== c2 ? c2 : Je, c2(e2, d2) && a.ref === b2.ref)) return hi(a, b2, f2);
  b2.flags |= 1;
  a = Tg(g2, d2);
  a.ref = b2.ref;
  a.return = b2;
...
function ki(a, b2, c2, d2, e2, f2) {
  if (null !== a && Je(a.memoizedProps, d2) && a.ref === b2.ref) if (ug = false, 0 !== (f2 & e2)) 0 !== (a.flags & 16384) && (ug = true);
  else return b2.lanes = a.lanes, hi(a, b2, f2);
  return li(a, b2, c2, d2, f2);
}
function mi(a, b2, c2) {
  var d2 = b2.pendingProps, e2 = d2.children, f2 = null !== a ? a.memoizedState : null;
  if ("hidden" === d2.mode || "unstable-defer-without-hiding" === d2.mode) if (0 === (b2.mode & 4)) b2.memoizedState = { baseLanes: 0 }, ni(b2, c2);
  else if (0 !== (c2 & 1073741824)) b2.memoizedState = { baseLanes: 0 }, ni(b2, null !== f2 ? f2.baseLanes : c2);
  else return a = null !== f2 ? f2.baseLanes | c2 : c2, b2.lanes = b2.childLanes = 1073741824, b2.memoizedState = { baseLanes: a }, ni(b2, a), null;
  else null !== f2 ? (d2 = f2.baseLanes | c2, b2.memoizedState = null) : d2 = c2, ni(b2, d2);
  fi(a, b2, e2, c2);
  return b2.child;
}
function oi(a, b2) {
  var c2 = b2.ref;
  if (null === a && null !== c2 || null !== a && a.ref !== c2) b2.flags |= 128;
}
...
function pi(a, b2, c2, d2, e2) {
  ...
  tg(b2, e2);
  if (null === b2.stateNode) null !== a && (a.alternate = null, b2.alternate = null, b2.flags |= 2), Mg(b2, c2, d2), Og(b2, c2, d2, e2), d2 = true;
  else if (null === a) {
...
function qi(a, b2, c2, d2, e2, f2) {
  ...
  if (!d2 && !g2) return e2 && Kf(b2, c2, false), hi(a, b2, f2);
  d2 = b2.stateNode;
  ei.current = b2;
...
function ti(a, b2, c2) {
  ...
  if (null === a) {
    ...
    a = d2.children;
    e2 = d2.fallback;
    if (f2) return a = ui(b2, a, e2, c2), b2.child.memoizedState = { baseLanes: c2 }, b2.memoizedState = si, a;
    if ("number" === typeof d2.unstable_expectedLoadTime) return a = ui(b2, a, e2, c2), b2.child.memoizedState = { baseLanes: c2 }, b2.memoizedState = si, b2.lanes = 33554432, a;
    c2 = vi({ mode: "visible", children: a }, b2.mode, c2, null);
    c2.return = b2;
    return b2.child = c2;
  }
  if (null !== a.memoizedState) {
    if (f2) return d2 = wi(a, b2, d2.children, d2.fallback, c2), f2 = b2.child, e2 = a.child.memoizedState, f2.memoizedState = null === e2 ? { baseLanes: c2 } : { baseLanes: e2.baseLanes | c2 }, f2.childLanes = a.childLanes & ~c2, b2.memoizedState = si, d2;
...
function Ai(a, b2, c2) {
  ...
  d2 = P.current;
  if (0 !== (d2 & 2)) d2 = d2 & 1 | 2, b2.flags |= 64;
  else {
    if (null !== a && 0 !== (a.flags & 64)) a: for (a = b2.child; null !== a; ) {
      if (13 === a.tag) null !== a.memoizedState && yi(a, c2);
      else if (19 === a.tag) yi(a, c2);
  ...
  if (0 === (b2.mode & 2)) b2.memoizedState = null;
    ...
    case "forwards":
      c2 = b2.child;
      for (e2 = null; null !== c2; ) a = c2.alternate, null !== a && null === ih(a) && (e2 = c2), c2 = c2.sibling;
      c2 = e2;
...
function hi(a, b2, c2) {
  ...
  if (0 !== (c2 & b2.childLanes)) {
    if (null !== a && b2.child !== a.child) throw Error(y$3(153));
    if (null !== b2.child) {
      a = b2.child;
      c2 = Tg(a, a.pendingProps);
      b2.child = c2;
      for (c2.return = b2; null !== a.sibling; ) a = a.sibling, c2 = c2.sibling = Tg(a, a.pendingProps), c2.return = b2;
      c2.sibling = null;
    }
    return b2.child;
  }
...
function Gi(a, b2, c2) {
  ...
  switch (b2.tag) {
    ...
    case 3:
      ...
      if (null === a || null === a.child) rh(b2) ? b2.flags |= 4 : d2.hydrate || (b2.flags |= 256);
      Ci(b2);
      return null;
    case 5:
      hh(b2);
      ...
      c2 = b2.type;
      if (null !== a && null != b2.stateNode) Di(a, b2, c2, d2, e2), a.ref !== b2.ref && (b2.flags |= 128);
      else {
        if (!d2) {
          if (null === b2.stateNode) throw Error(y$3(166));
          return null;
        }
        a = dh(ah.current);
        if (rh(b2)) {
          ...
          switch (c2) {
            ...
            case "video":
            case "audio":
              for (a = 0; a < Xe.length; a++) G$2(Xe[a], d2);
              break;
            case "source":
              G$2("error", d2);
              break;
          ...
          vb(c2, f2);
          a = null;
          for (var g2 in f2) f2.hasOwnProperty(g2) && (e2 = f2[g2], "children" === g2 ? "string" === typeof e2 ? d2.textContent !== e2 && (a = ["children", e2]) : "number" === typeof e2 && d2.textContent !== "" + e2 && (a = ["children", "" + e2]) : ca.hasOwnProperty(g2) && null != e2 && "onScroll" === g2 && G$2("scroll", d2));
          switch (c2) {
            case "input":
              Va(d2);
              cb(d2, f2, true);
          ...
          switch (c2) {
            ...
            case "video":
            case "audio":
              for (e2 = 0; e2 < Xe.length; e2++) G$2(Xe[e2], a);
              e2 = d2;
              break;
            case "source":
              G$2("error", a);
      ...
      return null;
    case 6:
      if (a && null != b2.stateNode) Ei(a, b2, a.memoizedProps, d2);
      else {
        if ("string" !== typeof d2 && null === b2.stateNode) throw Error(y$3(166));
        c2 = dh(ch.current);
        dh(ah.current);
    ...
    case 13:
      H$2(P);
      d2 = b2.memoizedState;
      if (0 !== (b2.flags & 64)) return b2.lanes = c2, b2;
      d2 = null !== d2;
      c2 = false;
      null === a ? void 0 !== b2.memoizedProps.fallback && rh(b2) : c2 = null !== a.memoizedState;
      if (d2 && !c2 && 0 !== (b2.mode & 2)) if (null === a && true !== b2.memoizedProps.unstable_avoidThisFallback || 0 !== (P.current & 1)) 0 === V$1 && (V$1 = 3);
      else {
    ...
    case 19:
      ...
      f2 = 0 !== (b2.flags & 64);
      g2 = d2.rendering;
      if (null === g2) if (f2) Fi(d2, false);
      else {
        if (0 !== V$1 || null !== a && 0 !== (a.flags & 64)) for (a = b2.child; null !== a; ) {
          g2 = ih(a);
          if (null !== g2) {
            b2.flags |= 64;
            Fi(d2, false);
        ...
        if (!f2) if (a = ih(g2), null !== a) {
          if (b2.flags |= 64, f2 = true, c2 = a.updateQueue, null !== c2 && (b2.updateQueue = c2, b2.flags |= 4), Fi(d2, true), null === d2.tail && "hidden" === d2.tailMode && !g2.alternate && !lh) return b2 = b2.lastEffect = d2.lastEffect, null !== b2 && (b2.nextEffect = null), null;
        } else 2 * O() - d2.renderingStartTime > Ji && 1073741824 !== c2 && (b2.flags |= 64, f2 = true, Fi(d2, false), b2.lanes = 33554432);
        d2.isBackwards ? (g2.sibling = b2.child, b2.child = g2) : (c2 = d2.last, null !== c2 ? c2.sibling = g2 : b2.child = g2, d2.last = g2);
      }
      return null !== d2.tail ? (c2 = d2.tail, d2.rendering = c2, d2.tail = c2.sibling, d2.lastEffect = b2.lastEffect, d2.renderingStartTime = O(), c2.sibling = null, b2 = P.current, I$2(P, f2 ? b2 & 1 | 2 : b2 & 1), c2) : null;
    case 23:
    case 24:
...
function Li(a) {
  switch (a.tag) {
    ...
    case 3:
      ...
      uh();
      b2 = a.flags;
      if (0 !== (b2 & 64)) throw Error(y$3(285));
      a.flags = b2 & -4097 | 64;
      return a;
    case 5:
      return hh(a), null;
    case 13:
      return H$2(P), b2 = a.flags, b2 & 4096 ? (a.flags = b2 & -4097 | 64, a) : null;
    case 19:
      return H$2(P), null;
    case 4:
      return fh(), null;
...
function aj(a, b2) {
  for (var c2 = a; ; ) {
    if (5 === c2.tag) {
      var d2 = c2.stateNode;
      if (b2) d2 = d2.style, "function" === typeof d2.setProperty ? d2.setProperty("display", "none", "important") : d2.display = "none";
      else {
        d2 = c2.stateNode;
    ...
    } else if (6 === c2.tag) c2.stateNode.nodeValue = b2 ? "" : c2.memoizedProps;
    ...
    if (c2 === a) break;
    for (; null === c2.sibling; ) {
      if (null === c2.return || c2.return === a) return;
      c2 = c2.return;
    }
    c2.sibling.return = c2.return;
    c2 = c2.sibling;
    ...
    case 22:
      ...
      if (null !== a && (a = a.lastEffect, null !== a)) {
        ...
        do {
          ...
          d2 = d2.tag;
          if (void 0 !== e2) if (0 !== (d2 & 4)) Zi(b2, c2);
          else {
            d2 = b2;
            try {
              e2();
...
function gj(a, b2, c2) {
  ...
  if (e2) a = e2 ? a.stateNode : a.stateNode.instance, b2 ? 8 === c2.nodeType ? c2.parentNode.insertBefore(a, b2) : c2.insertBefore(a, b2) : (8 === c2.nodeType ? (b2 = c2.parentNode, b2.insertBefore(a, c2)) : (b2 = c2, b2.appendChild(a)), c2 = c2._reactRootContainer, null !== c2 && void 0 !== c2 || null !== b2.onclick || (b2.onclick = jf));
  else if (4 !== d2 && (a = a.child, null !== a)) for (gj(a, b2, c2), a = a.sibling; null !== a; ) gj(a, b2, c2), a = a.sibling;
}
function hj(a, b2, c2) {
  var d2 = a.tag, e2 = 5 === d2 || 6 === d2;
  if (e2) a = e2 ? a.stateNode : a.stateNode.instance, b2 ? c2.insertBefore(a, b2) : c2.appendChild(a);
  else if (4 !== d2 && (a = a.child, null !== a)) for (hj(a, b2, c2), a = a.sibling; null !== a; ) hj(a, b2, c2), a = a.sibling;
}
function cj(a, b2) {
  for (var c2 = b2, d2 = false, e2, f2; ; ) {
    if (!d2) {
      d2 = c2.return;
      a: for (; ; ) {
        if (null === d2) throw Error(y$3(160));
        e2 = d2.stateNode;
        switch (d2.tag) {
          case 5:
            f2 = false;
    ...
    if (5 === c2.tag || 6 === c2.tag) {
      a: for (var g2 = a, h2 = c2, k2 = h2; ; ) if (bj(g2, k2), null !== k2.child && 4 !== k2.tag) k2.child.return = k2, k2 = k2.child;
      else {
        if (k2 === h2) break a;
        for (; null === k2.sibling; ) {
          if (null === k2.return || k2.return === h2) break a;
          k2 = k2.return;
        }
...
function ij(a, b2) {
  switch (b2.tag) {
    ...
    case 5:
      ...
      return;
    case 6:
      if (null === b2.stateNode) throw Error(y$3(162));
...
function Jg(a, b2, c2) {
  ...
  if (null === a) return null;
  $c(a, b2, c2);
  a === U$1 && (Hi |= b2, 4 === V$1 && Ii(a, W$1));
  var d2 = eg();
  1 === b2 ? 0 !== (X$1 & 8) && 0 === (X$1 & 48) ? Lj(a) : (Mj(a, c2), 0 === X$1 && (wj(), ig())) : (0 === (X$1 & 4) || 98 !== d2 && 99 !== d2 || (null === Cj ? Cj = /* @__PURE__ */ new Set([a]) : Cj.add(a)), Mj(a, c2));
  vj = a;
}
function Kj(a, b2) {
  a.lanes |= b2;
...
function Mj(a, b2) {
  for (var c2 = a.callbackNode, d2 = a.suspendedLanes, e2 = a.pingedLanes, f2 = a.expirationTimes, g2 = a.pendingLanes; 0 < g2; ) {
    ...
    } else l2 <= b2 && (a.expiredLanes |= k2);
    g2 &= ~k2;
  }
  d2 = Uc(a, a === U$1 ? W$1 : 0);
  b2 = F$2;
  if (0 === d2) null !== c2 && (c2 !== Zf && Pf(c2), a.callbackNode = null, a.callbackPriority = 0);
  else {
    if (null !== c2) {
      if (a.callbackPriority === b2) return;
      c2 !== Zf && Pf(c2);
    }
...
function Nj(a) {
  ...
  if (Oj() && a.callbackNode !== b2) return null;
  var c2 = Uc(a, a === U$1 ? W$1 : 0);
  if (0 === c2) return null;
  var d2 = c2;
  var e2 = X$1;
  X$1 |= 16;
  var f2 = Pj();
  if (U$1 !== a || W$1 !== d2) wj(), Qj(a, d2);
  do
    try {
      Rj();
      break;
  ...
  if (0 !== (tj & Hi)) Qj(a, 0);
    ...
    2 === d2 && (X$1 |= 64, a.hydrate && (a.hydrate = false, qf(a.containerInfo)), c2 = Wc(a), 0 !== c2 && (d2 = Tj(a, c2)));
    if (1 === d2) throw b2 = sj, Qj(a, 0), Ii(a, c2), Mj(a, O()), b2;
...
function Lj(a) {
  ...
  } else b2 = Uc(a, 0), c2 = Tj(a, b2);
  0 !== a.tag && 2 === c2 && (X$1 |= 64, a.hydrate && (a.hydrate = false, qf(a.containerInfo)), b2 = Wc(a), 0 !== b2 && (c2 = Tj(a, b2)));
  if (1 === c2) throw c2 = sj, Qj(a, 0), Ii(a, b2), Mj(a, O()), c2;
  a.finishedWork = a.current.alternate;
  a.finishedLanes = b2;
  Uj(a);
  Mj(a, O());
          ...
          do {
            ...
            if (C2) {
              ...
              if (0 === (p2.mode & 2)) {
                ...
                h2.flags |= 16384;
                h2.flags &= -2981;
                if (1 === h2.tag) if (null === h2.alternate) h2.tag = 17;
                else {
                  var t2 = zg(-1, 1);
                  t2.tag = 2;
                  Ag(h2, t2);
  ...
  do {
    ...
    if (0 === (b2.flags & 2048)) {
      ...
      if (24 !== c2.tag && 23 !== c2.tag || null === c2.memoizedState || 0 !== (qj & 1073741824) || 0 === (c2.mode & 4)) {
        for (var d2 = 0, e2 = c2.child; null !== e2; ) d2 |= e2.lanes | e2.childLanes, e2 = e2.sibling;
        c2.childLanes = d2;
      }
...
function dk(a, b2) {
  ...
  a.finishedWork = null;
  a.finishedLanes = 0;
  if (c2 === a.current) throw Error(y$3(177));
  a.callbackNode = null;
  ...
  if (null !== d2) {
    ...
    g2 = Ne$1();
    if (Oe$1(g2)) {
      if ("selectionStart" in g2) h2 = { start: g2.selectionStart, end: g2.selectionEnd };
      else a: if (h2 = (h2 = g2.ownerDocument) && h2.defaultView || window, (l2 = h2.getSelection && h2.getSelection()) && 0 !== l2.rangeCount) {
        h2 = l2.anchorNode;
        f2 = l2.anchorOffset;
        k2 = l2.focusNode;
        l2 = l2.focusOffset;
        ...
        b: for (; ; ) {
          for (var u2; ; ) {
            ...
            if (null === (u2 = w2.firstChild)) break;
            z2 = w2;
            w2 = u2;
          }
          for (; ; ) {
            ...
            z2 === h2 && ++C2 === f2 && (A2 = n2);
            z2 === k2 && ++x2 === l2 && (p2 = n2);
            if (null !== (u2 = w2.nextSibling)) break;
            w2 = z2;
            z2 = w2.parentNode;
          }
          w2 = u2;
  ...
  if (xj) xj = false, yj = a, zj = b2;
  else for (Z$1 = d2; null !== Z$1; ) b2 = Z$1.nextEffect, Z$1.nextEffect = null, Z$1.flags & 8 && (K2 = Z$1, K2.sibling = null, K2.stateNode = null), Z$1 = b2;
  d2 = a.pendingLanes;
  0 === d2 && (Ti = null);
...
function ek() {
  for (; null !== Z$1; ) {
    var a = Z$1.alternate;
    Jj || null === Ij || (0 !== (Z$1.flags & 8) ? dc(Z$1, Ij) && (Jj = true) : 13 === Z$1.tag && mj(a, Z$1) && dc(Z$1, Ij) && (Jj = true));
    var b2 = Z$1.flags;
    0 !== (b2 & 256) && Xi(a, Z$1);
...
function fk() {
  ...
  for (var d2 = 0; d2 < c2.length; d2 += 2) {
    ...
    if ("function" === typeof g2) try {
      ...
      if (null === f2) throw Error(y$3(330));
      Wi(f2, k2);
    }
  }
  c2 = Aj;
  ...
  for (h2 = a.current.firstEffect; null !== h2; ) a = h2.nextEffect, h2.nextEffect = null, h2.flags & 8 && (h2.sibling = null, h2.stateNode = null), h2 = a;
  X$1 = b2;
  ig();
  return true;
}
  ...
  if (3 === a.tag) gk(a, a, b2);
    ...
    if (3 === c2.tag) {
      ...
      if ("function" === typeof c2.type.getDerivedStateFromError || "function" === typeof d2.componentDidCatch && (null === Ti || !Ti.has(d2))) {
        ...
        e2 = Hg();
        c2 = Kj(c2, 1);
        if (null !== c2) $c(c2, 1, e2), Mj(c2, e2);
        else if ("function" === typeof d2.componentDidCatch && (null === Ti || !Ti.has(d2))) try {
...
function Yj(a, b2, c2) {
  ...
  U$1 === a && (W$1 & c2) === c2 && (4 === V$1 || 3 === V$1 && (W$1 & 62914560) === W$1 && 500 > O() - jj ? Qj(a, 0) : uj |= c2);
  Mj(a, b2);
}
function lj(a, b2) {
  var c2 = a.stateNode;
...
ck = function(a, b2, c2) {
  var d2 = b2.lanes;
  if (null !== a) if (a.memoizedProps !== b2.pendingProps || N$1.current) ug = true;
  else if (0 !== (c2 & d2)) ug = 0 !== (a.flags & 16384) ? true : false;
  else {
    ug = false;
    switch (b2.tag) {
      case 3:
      ...
      case 13:
        if (null !== b2.memoizedState) {
          if (0 !== (c2 & b2.child.childLanes)) return ti(a, b2, c2);
          I$2(P, P.current & 1);
          b2 = hi(a, b2, c2);
  ...
  switch (b2.tag) {
    case 2:
      ...
      } else b2.tag = 0, fi(null, b2, e2, c2), b2 = b2.child;
      return b2;
    case 16:
      e2 = b2.elementType;
      a: {
    ...
    case 3:
      ri(b2);
      d2 = b2.updateQueue;
      if (null === a || null === d2) throw Error(y$3(282));
      d2 = b2.pendingProps;
      e2 = b2.memoizedState;
      ...
      if (d2 === e2) sh(), b2 = hi(a, b2, c2);
      else {
        e2 = b2.stateNode;
        if (f2 = e2.hydrate) kh = rf(b2.stateNode.containerInfo.firstChild), jh = b2, f2 = lh = true;
        if (f2) {
          a = e2.mutableSourceEagerHydrationData;
          if (null != a) for (e2 = 0; e2 < a.length; e2 += 2) f2 = a[e2], f2._workInProgressVersionPrimary = a[e2 + 1], th.push(f2);
          c2 = Zg(b2, null, d2, c2);
          for (b2.child = c2; c2; ) c2.flags = c2.flags & -3 | 1024, c2 = c2.sibling;
        } else fi(a, b2, d2, c2), sh();
        b2 = b2.child;
      }
      return b2;
    case 5:
    ...
    case 10:
      a: {
        ...
        h2._currentValue = f2;
        if (null !== g2) if (h2 = g2.value, f2 = He(h2, f2) ? 0 : ("function" === typeof d2._calculateChangedBits ? d2._calculateChangedBits(h2, f2) : 1073741823) | 0, 0 === f2) {
...
function lk(a, b2, c2, d2) {
  ...
  a: if (c2) {
    ...
    b: {
      if (Zb(c2) !== c2 || 1 !== c2.tag) throw Error(y$3(170));
      var h2 = c2;
      do {
        switch (h2.tag) {
          case 3:
...
reactDom_production_min.flushSync = function(a, b2) {
  var c2 = X$1;
  if (0 !== (c2 & 48)) return a(b2);
  X$1 |= 1;
  try {
    if (a) return gg(99, a.bind(null, b2));
  } finally {
    X$1 = c2, ig();
  }
};
...
function deepmerge(target, source2) {
  ...
  if (isPlainObject(target) && isPlainObject(source2)) {
    Object.keys(source2).forEach(function(key2) {
      ...
      if (isPlainObject(source2[key2]) && key2 in target) {
        output[key2] = deepmerge(target[key2], source2[key2], options);
      } else {
...
function createTheme() {
  ...
  muiTheme2 = args.reduce(function(acc, argument) {
...
var BaseStyleRule = /* @__PURE__ */ function() {
  function BaseStyleRule2(key2, style, options) {
    this.type = "style";
...
var StyleRule = /* @__PURE__ */ function(_BaseStyleRule) {
  ...
  function StyleRule2(key2, style, options) {
    var _this;
    _this = _BaseStyleRule.call(this, key2, style, options) || this;
...
var pluginStyleRule = {
  onCreateRule: function onCreateRule(key2, style, options) {
    if (key2[0] === "@" || options.parent && options.parent.type === "keyframes") {
      return null;
    }
    return new StyleRule(key2, style, options);
  }
};
...
var ConditionalRule = /* @__PURE__ */ function() {
  function ConditionalRule2(key2, styles4, options) {
...
var pluginConditionalRule = {
  onCreateRule: function onCreateRule2(key2, styles4, options) {
    return keyRegExp.test(key2) ? new ConditionalRule(key2, styles4, options) : null;
  }
};
...
var pluginKeyframeRule = {
  onCreateRule: function onCreateRule4(key2, style, options) {
    if (options.parent && options.parent.type === "keyframes") {
      return new KeyframeRule(key2, style, options);
    }
    return null;
  }
};
var FontFaceRule = /* @__PURE__ */ function() {
  function FontFaceRule2(key2, style, options) {
    this.type = "font-face";
    this.at = "@font-face";
    this.isProcessed = false;
    this.key = key2;
...
var pluginFontFaceRule = {
  onCreateRule: function onCreateRule5(key2, style, options) {
    return keyRegExp$2.test(key2) ? new FontFaceRule(key2, style, options) : null;
  }
};
var ViewportRule = /* @__PURE__ */ function() {
  function ViewportRule2(key2, style, options) {
    this.type = "viewport";
    this.at = "@viewport";
    this.isProcessed = false;
    this.key = key2;
...
var pluginViewportRule = {
  onCreateRule: function onCreateRule6(key2, style, options) {
    return key2 === "@viewport" || key2 === "@-ms-viewport" ? new ViewportRule(key2, style, options) : null;
  }
};
...
function getDynamicStyles(styles4) {
  var to = null;
  for (var key2 in styles4) {
    var value = styles4[key2];
...
var GlobalContainerRule = /* @__PURE__ */ function() {
  function GlobalContainerRule2(key2, styles4, options) {
    this.type = "global";
    this.at = at;
    this.isProcessed = false;
    this.key = key2;
...
var GlobalPrefixedRule = /* @__PURE__ */ function() {
  function GlobalPrefixedRule2(key2, style, options) {
    this.type = "global";
    this.at = at;
    this.isProcessed = false;
    this.key = key2;
...
var plugins = [appearence, colorAdjust, mask, textOrientation, transform, transition$1, writingMode, userSelect, breakPropsOld, inlineLogicalOld, unprefixed, prefixed, scrollSnap, overscrollBehavior, flex2012, flex2009];
...
reactIs_production_min$1.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === e$1 || a === m$2 || a === g$2 || a === f$1 || a === p$1 || a === q$2 || "object" === typeof a && null !== a && (a.$$typeof === t || a.$$typeof === r$1 || a.$$typeof === h$1 || a.$$typeof === k$2 || a.$$typeof === n$1 || a.$$typeof === w$2 || a.$$typeof === x$2 || a.$$typeof === y$2 || a.$$typeof === v$2);
};
...
function useControlled(_ref3) {
  ...
  _ref3.name;
  _ref3.state;
  var _React$useRef = reactExports.useRef(controlled !== void 0), isControlled = _React$useRef.current;
  var _React$useState = reactExports.useState(defaultProp), valueState = _React$useState[0], setValue = _React$useState[1];
  var value = isControlled ? controlled : valueState;
  var setValueIfUncontrolled = reactExports.useCallback(function(newValue) {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function useId(idOverride) {
  var _React$useState = reactExports.useState(idOverride), defaultId = _React$useState[0], setDefaultId = _React$useState[1];
 ...
 * LICENSE file in the root directory of this source tree.
 */
var b$1 = 60103, c$1 = 60106, d = 60107, e = 60108, f = 60114, g$1 = 60109, h = 60110, k$1 = 60112, l = 60113, m = 60120, n = 60115, p = 60116, q$1 = 60121, r = 60122, u = 60117, v$1 = 60129, w$1 = 60131;
if ("function" === typeof Symbol && Symbol.for) {
  var x$1 = Symbol.for;
...
var z$1 = g$1, A = b$1, B$1 = k$1, C$1 = d, D$1 = p, E$1 = n, F$1 = c$1, G$1 = f, H$1 = e, I$1 = l;
...
reactIs_production_min.isValidElementType = function(a) {
  return "string" === typeof a || "function" === typeof a || a === d || a === f || a === v$1 || a === e || a === l || a === m || a === w$1 || "object" === typeof a && null !== a && (a.$$typeof === p || a.$$typeof === n || a.$$typeof === g$1 || a.$$typeof === h || a.$$typeof === k$1 || a.$$typeof === u || a.$$typeof === q$1 || a[0] === r) ? true : false;
};
...
var TouchRipple = /* @__PURE__ */ reactExports.forwardRef(function TouchRipple2(props, ref) {
  ...
  var stop = reactExports.useCallback(function(event, cb2) {
    clearTimeout(startTimer.current);
...
var Fade = /* @__PURE__ */ reactExports.forwardRef(function Fade2(props, ref) {
...
var Button$1 = /* @__PURE__ */ reactExports.forwardRef(function Button2(props, ref) {
...
var CircularProgress = /* @__PURE__ */ reactExports.forwardRef(function CircularProgress2(props, ref) {
  ...
  return /* @__PURE__ */ reactExports.createElement("div", _extends({
    ...
    ref,
    role: "progressbar"
  }, rootProps, other), /* @__PURE__ */ reactExports.createElement("svg", {
...
var Portal = /* @__PURE__ */ reactExports.forwardRef(function Portal2(props, ref) {
  ...
  }, [onRendered, mountNode2, disablePortal]);
  if (disablePortal) {
  ...
  return mountNode2 ? /* @__PURE__ */ reactDomExports.createPortal(children, mountNode2) : mountNode2;
});
...
function ariaHiddenSiblings(container, mountNode2, currentNode) {
  var nodesToExclude = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : [];
  var show = arguments.length > 4 ? arguments[4] : void 0;
  var blacklist = [mountNode2, currentNode].concat(_toConsumableArray(nodesToExclude));
...
var Modal = /* @__PURE__ */ reactExports.forwardRef(function Modal2(inProps, ref) {
...
var Dialog = /* @__PURE__ */ reactExports.forwardRef(function Dialog2(props, ref) {
  ...
  var mouseDownTarget = reactExports.useRef();
  ...
  }, TransitionProps), /* @__PURE__ */ reactExports.createElement("div", {
...
var TextareaAutosize = /* @__PURE__ */ reactExports.forwardRef(function TextareaAutosize2(props, ref) {
  ...
  var _React$useRef = reactExports.useRef(value != null), isControlled = _React$useRef.current;
  var inputRef = reactExports.useRef(null);
  var handleRef = useForkRef(ref, inputRef);
  var shadowRef = reactExports.useRef(null);
  var renders = reactExports.useRef(0);
  var _React$useState = reactExports.useState({}), state = _React$useState[0], setState = _React$useState[1];
  ...
  }, other)), /* @__PURE__ */ reactExports.createElement("textarea", {
    "aria-hidden": true,
...
var InputBase = /* @__PURE__ */ reactExports.forwardRef(function InputBase2(props, ref) {
  ...
  var _React$useState = reactExports.useState(false), focused = _React$useState[0], setFocused = _React$useState[1];
...
var FormControl = /* @__PURE__ */ reactExports.forwardRef(function FormControl2(props, ref) {
  ...
  var _React$useState3 = reactExports.useState(false), _focused = _React$useState3[0], setFocused = _React$useState3[1];
  var focused = visuallyFocused !== void 0 ? visuallyFocused : _focused;
  if (disabled && focused) {
    setFocused(false);
  }
  var registerEffect;
  var onFilled = reactExports.useCallback(function() {
    setFilled(true);
  }, []);
  var onEmpty = reactExports.useCallback(function() {
    setFilled(false);
  }, []);
  var childContext = {
    adornedStart,
...
var FormHelperText = /* @__PURE__ */ reactExports.forwardRef(function FormHelperText2(props, ref) {
...
var FormLabel = /* @__PURE__ */ reactExports.forwardRef(function FormLabel2(props, ref) {
...
var Grow = /* @__PURE__ */ reactExports.forwardRef(function Grow2(props, ref) {
...
var InputLabel = /* @__PURE__ */ reactExports.forwardRef(function InputLabel2(props, ref) {
...
var LinearProgress = /* @__PURE__ */ reactExports.forwardRef(function LinearProgress2(props, ref) {
  ...
  return /* @__PURE__ */ reactExports.createElement("div", _extends({
    ...
    ref
  }, other), variant === "buffer" ? /* @__PURE__ */ reactExports.createElement("div", {
  ...
  }), variant === "determinate" ? null : /* @__PURE__ */ reactExports.createElement("div", {
...
var List = /* @__PURE__ */ reactExports.forwardRef(function List2(props, ref) {
...
var Popover = /* @__PURE__ */ reactExports.forwardRef(function Popover2(props, ref) {
...
var MenuList = /* @__PURE__ */ reactExports.forwardRef(function MenuList2(props, ref) {
  ...
  reactExports.useImperativeHandle(actions2, function() {
    return {
  ...
  var handleOwnRef = reactExports.useCallback(function(instance) {
    listRef.current = reactDomExports.findDOMNode(instance);
  }, []);
  var handleRef = useForkRef(handleOwnRef, ref);
...
var Menu = /* @__PURE__ */ reactExports.forwardRef(function Menu2(props, ref) {
  ...
  var contentAnchorRef = reactExports.useRef(null);
    ...
    if (index === activeItemIndex) {
      return /* @__PURE__ */ reactExports.cloneElement(child, {
        ref: function ref2(instance) {
          contentAnchorRef.current = reactDomExports.findDOMNode(instance);
...
var MenuItem = /* @__PURE__ */ reactExports.forwardRef(function MenuItem2(props, ref) {
...
var NativeSelectInput = /* @__PURE__ */ reactExports.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, /* @__PURE__ */ reactExports.createElement("select", _extends({
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : /* @__PURE__ */ reactExports.createElement(IconComponent, {
...
var defaultInput = /* @__PURE__ */ reactExports.createElement(Input$1, null);
var NativeSelect = /* @__PURE__ */ reactExports.forwardRef(function NativeSelect2(props, ref) {
...
var NotchedOutline = /* @__PURE__ */ reactExports.forwardRef(function NotchedOutline2(props, ref) {
  props.children;
  ...
  if (label !== void 0) {
    ...
    }, label ? /* @__PURE__ */ reactExports.createElement("span", null, label) : /* @__PURE__ */ reactExports.createElement("span", {
      dangerouslySetInnerHTML: {
        __html: "&#8203;"
      }
    })));
...
var SelectInput = /* @__PURE__ */ reactExports.forwardRef(function SelectInput2(props, ref) {
  ...
  var inputRef = reactExports.useRef(null);
  var _React$useState = reactExports.useState(null), displayNode = _React$useState[0], setDisplayNode = _React$useState[1];
  var _React$useRef = reactExports.useRef(openProp != null), isOpenControlled = _React$useRef.current;
  var _React$useState2 = reactExports.useState(), menuMinWidthState = _React$useState2[0], setMenuMinWidthState = _React$useState2[1];
  var _React$useState3 = reactExports.useState(false), openState = _React$useState3[0], setOpenState = _React$useState3[1];
...
function setValueIndex(_ref3) {
  var values2 = _ref3.values, source2 = _ref3.source, newValue = _ref3.newValue, index = _ref3.index;
...
var Slider = /* @__PURE__ */ reactExports.forwardRef(function Slider2(props, ref) {
  ...
  var theme = useTheme();
  var touchId = reactExports.useRef();
  var _React$useState = reactExports.useState(-1), active = _React$useState[0], setActive = _React$useState[1];
  var _React$useState2 = reactExports.useState(-1), open = _React$useState2[0], setOpen = _React$useState2[1];
  var _useControlled = useControlled({
    controlled: valueProp,
    default: defaultValue,
    name: "Slider"
  ...
  var marks = marksProp === true && step !== null ? _toConsumableArray(Array(Math.floor((max - min) / step) + 1)).map(function(_2, index) {
    return {
      value: min + step * index
    };
  }) : marksProp || [];
  var _useIsFocusVisible = useIsFocusVisible(), isFocusVisible2 = _useIsFocusVisible.isFocusVisible, onBlurVisible = _useIsFocusVisible.onBlurVisible, focusVisibleRef = _useIsFocusVisible.ref;
  var _React$useState3 = reactExports.useState(-1), focusVisible = _React$useState3[0], setFocusVisible = _React$useState3[1];
  ...
  var previousIndex = reactExports.useRef();
  var axis = orientation;
  if (isRtl && orientation !== "vertical") {
    axis += "-reverse";
  }
  var getFingerNewValue = function getFingerNewValue2(_ref3) {
    var finger = _ref3.finger, _ref3$move = _ref3.move, move = _ref3$move === void 0 ? false : _ref3$move, values22 = _ref3.values, source2 = _ref3.source;
    ...
    if (axis.indexOf("vertical") === 0) {
      percent2 = (bottom - finger.y) / height;
    } else {
      percent2 = (finger.x - left) / width;
    }
  ...
  return /* @__PURE__ */ reactExports.createElement(Component, _extends({
    ...
    }), mark.label != null ? /* @__PURE__ */ reactExports.createElement("span", {
      "aria-hidden": true,
      "data-index": index,
      style,
    ...
    var style = axisProps[axis].offset(percent2);
    return /* @__PURE__ */ reactExports.createElement(ValueLabelComponent, {
      key: index,
      valueLabelFormat,
      valueLabelDisplay,
      ...
      disabled
    }, /* @__PURE__ */ reactExports.createElement(ThumbComponent, {
...
var TextField = /* @__PURE__ */ reactExports.forwardRef(function TextField2(props, ref) {
  ...
  if (variant === "outlined") {
    ...
    if (label) {
      ...
      InputMore.label = /* @__PURE__ */ reactExports.createElement(reactExports.Fragment, null, label, displayRequired && " *");
    }
  }
  if (select) {
...
const useForceUpdate = () => {
  ...
  const fn = reactExports.useCallback(
    () => {
      forceUpdate({});
    },
    []
...
const createProvider = ({ init, attach: attach2 }) => {
  const result = {
    value: void 0,
    attach: () => {
    },
  ...
  result.attach = (onChange) => {
    unmountFunction = attach2?.(onFetchValueChanged);
  ...
  result.detach = (onChange) => {
    ...
    if (events.count("change") === 0) {
      unmountFunction?.();
      unmountFunction = void 0;
    }
  };
  return result;
};
const currentScene = (obs) => createProvider({
  init: (onChanged) => {
    if (obs.adapter) {
    ...
    obs.adapter?.on("CurrentProgramSceneChanged", (data) => {
      onChanged({
        name: data.sceneName,
        sceneUuid: data.sceneUuid
      });
...
const useCurrentScene = (obs) => {
  return obs.useDataProvider("currentScene");
};
const isStreaming = (obs) => createProvider({
  init: (onChanged) => {
    const setData = (state) => {
      onChanged({
    ...
    obs.adapter?.on("StreamStateChanged", (data) => {
...
const useIsStreaming = (obs) => {
  return obs.useDataProvider("isStreaming");
};
const isRecording = (obs) => createProvider({
  init: (onChanged) => {
    const setData = (state) => {
      onChanged({
        isStarted: state === "started",
    ...
    obs.adapter?.on("RecordStateChanged", (data) => {
      switch (data.outputState) {
        case "OBS_WEBSOCKET_OUTPUT_STARTING":
          setData("starting");
          break;
...
const useStats = (obs, args) => {
  return obs.useDataProvider("stats", args);
};
const sceneItemList = (obs, {
  scene
}) => createProvider({
  init: (onChanged) => {
    ...
    fetchSceneItems();
    obs.adapter?.on("SceneItemCreated", (data) => {
      if (data.sceneName === scene) {
        fetchSceneItems();
      }
    });
    obs.adapter?.on("SceneItemRemoved", (data) => {
      if (data.sceneName === scene) {
        fetchSceneItems();
      }
    });
    obs.adapter?.on("SceneItemListReindexed", (data) => {
      if (data.sceneName === scene) {
        fetchSceneItems();
      }
    });
...
const useSceneItemList = (obs, args) => {
  return obs.useDataProvider("sceneItemList", args);
};
const sceneItemProperties = (obs, {
  scene,
  item,
  sceneItemId
}) => createProvider({
  init: (onChanged) => {
    const fetchProperties = async () => {
      ...
      try {
        ...
        if (itemId === void 0 && item) {
          const sceneItems = await obs.adapter.getSceneItemList(scene);
          const foundItem = sceneItems.find((si2) => si2.sourceName === item);
          if (foundItem) {
    ...
    fetchProperties();
    obs.adapter?.on("SceneItemEnableStateChanged", (data) => {
      if (data.sceneName === scene && (data.sceneItemId === sceneItemId || !sceneItemId)) {
        fetchProperties();
      }
    });
    obs.adapter?.on("SceneItemLockStateChanged", (data) => {
      if (data.sceneName === scene && (data.sceneItemId === sceneItemId || !sceneItemId)) {
        fetchProperties();
      }
    });
    obs.adapter?.on("SceneItemTransformChanged", (data) => {
      if (data.sceneName === scene && (data.sceneItemId === sceneItemId || !sceneItemId)) {
        fetchProperties();
      }
    });
...
const useSceneItemProperties = (obs, args) => {
  return obs.useDataProvider("sceneItemProperties", args);
};
const transition = (obs) => createProvider({
  init: (onChanged) => {
    obs.adapter?.on("SceneTransitionStarted", (data) => {
      onChanged(data);
    });
...
const useVideoInfo = (obs, args) => {
  return obs.useDataProvider("videoInfo", args);
};
const inputVolume = (obs, {
  inputName
}) => createProvider({
  init: (onChanged) => {
    ...
    fetchInputVolume();
    obs.adapter?.on("InputVolumeChanged", (data) => {
...
const inputMute = (obs, {
  ...
  init: (onChanged) => {
    ...
    fetchInputMute();
    obs.adapter?.on("InputMuteStateChanged", (data) => {
      if (data.inputName === inputName) {
        onChanged({
          inputMuted: data.inputMuted
        });
...
const useInputMute = (obs, args) => {
  return obs.useDataProvider("inputMute", args);
};
const inputVolumeMeters = (obs, {
  inputName,
  onMeterUpdate
}) => createProvider({
  init: (onChanged) => {
    ...
    obs.adapter?.on("InputVolumeMeters", (data) => {
...
const useInputVolumeMeters = (obs, args) => {
...
async function getAuthResponse(password, challenge, salt) {
  try {
...
function camelCaseKeys(obj) {
  ...
  for (const key2 in obj) {
    if (Object.prototype.hasOwnProperty.call(obj, key2)) {
      const camelCaseKey = key2.replace(/-([a-z])/g, (_match, char) => char.toUpperCase());
      const value = obj[key2];
      if (Array.isArray(value)) {
        camelCasedObj[camelCaseKey] = value.map(
          (item) => typeof item === "object" && item !== null ? camelCaseKeys(item) : item
        );
...
class V4Adapter {
  ...
  async getSceneItemList(sceneName) {
    ...
    const normalized = camelCaseKeys(data);
    return normalized.sceneItems.map((item) => ({
  ...
  async getSceneItemProperties(sceneName, sceneItemId) {
  ...
  async setSceneItemIndex(sceneName, sceneItemId, sceneItemIndex) {
    ...
    await this._sendRaw("ReorderSceneItems", {
      scene: sceneName,
      items: reorderedItems.reverse()
      // Reverse for v4 ordering
    });
  }
  // =========================================================================
  // Recording
  ...
  async getInputVolume(inputName) {
    ...
    return {
      ...
      inputVolumeDb: normalized.volumeDb ?? 20 * Math.log10(normalized.volume || 1e-4)
    };
  }
  async setInputVolume(inputName, inputVolumeMul, inputVolumeDb) {
    let volume = inputVolumeMul;
    if (volume === void 0 && inputVolumeDb !== void 0) {
  ...
  async getStats() {
    ...
    const normalized = camelCaseKeys(data);
    const stats2 = normalized.stats || normalized;
    return {
      cpuUsage: stats2.cpuUsage,
      memoryUsage: stats2.memoryUsage,
      availableDiskSpace: stats2.freeDiskSpace,
      activeFps: stats2.fps,
      averageFrameRenderTime: stats2.averageFrameTime,
      renderSkippedFrames: stats2.renderMissedFrames,
      renderTotalFrames: stats2.renderTotalFrames,
      outputSkippedFrames: stats2.outputSkippedFrames,
      outputTotalFrames: stats2.outputTotalFrames
    };
  }
  ...
  // Screenshots
  // =========================================================================
  async getSourceScreenshot(sourceName, imageFormat, imageWidth, imageHeight) {
  ...
  // Raw Access
  // =========================================================================
  async sendRaw(requestType, requestData) {
    return this._sendRaw(requestType, requestData || {});
  }
  async _sendRaw(requestType, requestData) {
    return new Promise((resolve, reject) => {
   ...
   */
  _normalizeEventData(eventType, data) {
    switch (eventType) {
      case "SwitchScenes":
        return {
      ...
      case "SourceVolumeChanged":
        return {
          ...
          inputVolumeDb: data.volumeDb ?? 20 * Math.log10(data.volume || 1e-4)
        };
...
class V5Adapter {
  ...
  async _identify() {
    let eventSubscriptions = 2047 | 524288;
  ...
  async getSceneItemList(sceneName) {
    ...
    return data.sceneItems.map((item) => ({
  ...
  // =========================================================================
  async getRecordStatus() {
    return this._sendRequest("GetRecordStatus", {});
  }
  async startRecord() {
  ...
  // =========================================================================
  async getStreamStatus() {
    return this._sendRequest("GetStreamStatus", {});
  }
  async startStream() {
  ...
  async setInputVolume(inputName, inputVolumeMul, inputVolumeDb) {
    await this._sendRequest("SetInputVolume", {
      inputName,
      ...inputVolumeMul !== void 0 && { inputVolumeMul },
      ...inputVolumeDb !== void 0 && { inputVolumeDb }
    });
  }
  async getInputMute(inputName) {
  ...
  async getVideoSettings() {
    return this._sendRequest("GetVideoSettings", {});
  }
  // =========================================================================
  // Screenshots
  // =========================================================================
  ...
  // =========================================================================
  async getCurrentSceneTransition() {
    return this._sendRequest("GetCurrentSceneTransition", {});
  }
  // =========================================================================
  // Events
  // =========================================================================
  ...
  _handleMessage(message) {
    const { op, d: d2 } = message;
    switch (op) {
      case 7:
        this._handleRequestResponse(d2);
        break;
      case 5:
        this._handleEvent(d2);
        break;
    }
  }
...
async function createV4Adapter(address, password) {
  const adapter = new V4Adapter();
  await adapter.connect(address, password);
  return adapter;
}
async function createV5Adapter(address, password, subscribeVolumeMeters = false) {
  const adapter = new V5Adapter();
  await adapter.connect(address, password, { subscribeVolumeMeters });
  return adapter;
}
async function detectAndCreateAdapter(address, password, subscribeVolumeMeters = false) {
  return new Promise((resolve, reject) => {
    const wsUrl = `ws://${address}`;
    let socket = null;
    let resolved = false;
    ...
    const resolveWithVersion = async (version) => {
      if (resolved) return;
      resolved = true;
      cleanup();
      try {
...
const obsContext = reactExports.createContext({ getConnection: () => null });
function hasAudioInputTiles(tiles) {
...
const OBSWebsocketProvider = ({ children }) => {
  ...
  const promptForPassword = (address) => {
      ...
      if (!connections[connectionName]) {
        ...
        const connect = async () => {
          ...
          try {
            ...
            const isAuthError = errorMsg.toLowerCase().includes("authentication failed") || err?.code === 401 || err?.code === 4009;
            if (isAuthError) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    obsContext.Provider,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog$1, { open: passwordPrompt.open, onClose: handlePasswordCancel, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle$1, { children: "Password Required" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent$1, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { marginBottom: 16 }, children: [
              "Enter password for ",
              passwordPrompt.address,
              ":"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              TextField$1,
              {
                ...
                fullWidth: true,
                value: passwordInput,
                onChange: (e2) => setPasswordInput(e2.target.value),
                onKeyPress: (e2) => {
                  if (e2.key === "Enter") {
...
const ThemeProvider = ({ children, theme }) => /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider$1, { theme: muiTheme, children: React$1.createElement(Le, {
  theme: {
    ...variables,
    ...theme || {}
  }
...
(function(module) {
  ...
  function _interopRequireWildcard2(e2, t2) {
    ...
    return (module.exports = _interopRequireWildcard2 = function _interopRequireWildcard3(e3, t3) {
      ...
      if (null === e3 || "object" != _typeof2(e3) && "function" != typeof e3) return f2;
      if (o = t3 ? n2 : r2) {
        if (o.has(e3)) return o.get(e3);
        o.set(e3, f2);
      }
      for (var _t in e3) "default" !== _t && {}.hasOwnProperty.call(e3, _t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e3, _t)) && (i.get || i.set) ? o(f2, _t, i) : f2[_t] = e3[_t]);
      return f2;
...
const Wrapper$2 = qe.div`
	...
	padding: ${(p2) => p2.theme.grid(4)} ${(p2) => p2.theme.grid(2)};
	background-color: ${(p2) => p2.theme.navBackground};
`;
const LogoContainer = qe.div`
	display: flex;
	align-items: center;
	gap: ${(p2) => p2.theme.grid(2)};
`;
const Logo = qe.img`
    max-height: ${(p2) => p2.theme.grid(6.75)};
`;
const Version = qe.span`
	font-size: ${(p2) => p2.theme.grid(1.5)};
...
const SelectionIndicator = qe.div`
	...
	box-shadow: 0 0 15px 10px ${(p2) => p2.theme.selectionHighlight};
	opacity: ${(p2) => !p2.$isSelected ? 0 : p2.$isDeselecting ? 0.6 : 1};
	z-index: ${(p2) => !p2.$isSelected || p2.$isDeselecting ? 5 : 10};
	pointer-events: none;
	transition: box-shadow 0.25s ease-in-out 0s, opacity 0.5s ease-in-out 0s;
`;
const TextOverlay = qe.div`
	position: absolute;
	...
	> p:not(:first-child) {
		margin-top: ${(p2) => p2.theme.fontSize.small};
	}
`;
const ImgOverlay = qe.div`
	position: absolute;
	width: ${(p2) => p2.$size * 16}px;
	height: ${(p2) => p2.$size * 9}px;
...
const THRESHOLD_ORANGE = (-20 + 60) / 60;
const THRESHOLD_RED = (-8 + 60) / 60;
const MeterSegments = qe.div`
	position: absolute;
	bottom: 0;
	left: 0;
	right: 0;
	...
	opacity: 0.25;
	filter: ${(p2) => p2.$muted ? "grayscale(1)" : "none"};
	transition: filter 0.15s;
`;
const MeterPeakFill = qe.div`
	position: absolute;
	bottom: 0;
	left: 0;
	right: 0;
    ...
    opacity: ${(p2) => p2.$muted ? "0.25" : "1"};
	filter: ${(p2) => p2.$muted ? "grayscale(1)" : "none"};
	transition: filter 0.15s;
`;
const ControlsArea = qe.div`
	display: flex;
	flex-direction: column;
	align-items: center;
	justify-content: center;
...
`;
const VolumeText = qe.span`
	font-size: ${(p2) => p2.theme.fontSize.large};
	font-weight: bold;
	min-width: 50px;
	text-align: center;
`;
const MuteIcon = qe.div`
	display: flex;
	align-items: center;
	justify-content: center;
	color: ${(p2) => p2.$muted ? "#ef4444" : "inherit"};
	
	svg {
		font-size: 28px;
	}
`;
const SliderContainer = qe.div`
	width: 100%;
	padding: 0 8px;
`;
const StyledSlider = qe(Slider$1)`
	color: ${(p2) => p2.theme.selectionHighlight};
...
const AudioInputTile = ({
  ...
  const meterPeakRef = reactExports.useRef(null);
  const latestMeterData = reactExports.useRef({
    peakOutput: 0,
    peakInput: 0
  });
  const animationFrameRef = reactExports.useRef();
  const mulToDisplayPercent = (mul) => {
    if (mul <= 0) return 0;
    const dB = 20 * Math.log10(mul);
    return Math.max(0, Math.min(1, (dB + 60) / 60));
  };
  const displayPercentToMul = (percent2) => {
    if (percent2 <= 0) return 0;
    const dB = percent2 * 60 - 60;
    return Math.pow(10, dB / 20);
  };
  const handleMeterUpdate = reactExports.useCallback((levels) => {
  ...
  const content = obs.connected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    obs.apiVersion === 5 && /* @__PURE__ */ jsxRuntimeExports.jsxs(MeterContainer, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MeterSegments, { $muted: isMuted }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(MeterPeakFill, { ref: meterPeakRef, $muted: isMuted })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ControlsArea, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(VolumeDisplay, { onClick: handleMuteToggle, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MuteIcon, { $muted: isMuted, children: isMuted ? /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeOff, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeUp, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(VolumeText, { children: isMuted ? "Muted" : `${displayPercent}%` })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SliderContainer, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        StyledSlider,
        {
          value: sliderValue,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TileWrapper$1,
    {
      ...
      overlay,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(TileContentArea, { $size: size, children: content })
    }
  );
};
...
const useLongPress = ({
  ...
  return reactExports.useMemo(
    () => ({
      onMouseDown: (e2) => start(e2),
      onTouchStart: (e2) => start(e2),
      onMouseUp: (e2) => clear(e2),
      onMouseLeave: (e2) => clear(e2, false),
      onTouchEnd: (e2) => clear(e2)
    }),
    [start, clear]
  );
};
...
const useClickHandler = ({
  ...
  const triggerHandler = React$1.useCallback(
    (action) => {
      if (action?.length) {
  ...
  const onLongPress = React$1.useCallback(
    () => {
...
const SceneItemButton = ({
  ...
  const isVisible = sceneItemProperties2?.sceneItemEnabled ?? false;
  ...
  const handlers = React$1.useMemo(
    () => ({
      toggleVisible: async () => {
        if (obs.connected && obs.adapter && sceneItemId !== void 0) {
          await obs.adapter.setSceneItemEnabled(
            scene,
            sceneItemId,
            !sceneItemProperties2?.sceneItemEnabled
          );
      ...
      moveToTop: async () => {
        if (!obs.adapter || !sceneItemList2 || sceneItemId === void 0) return;
        const topIndex = sceneItemList2.length - 1;
        await obs.adapter.setSceneItemIndex(scene, sceneItemId, topIndex);
      }
    }),
    [scene, item, sceneItemList2, sceneItemProperties2, sceneItemId, obs]
  );
  ...
  const overlay = !obs.connected ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Disabled" }),
    click !== "toggleVisible" && longPress === "toggleVisible" ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("em", { children: "Hold to enable" }) }) : null
  ] }) : null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TileWrapper$1,
    {
...
`;
const formatMB = (mb2) => {
  return mb2 > 1e3 ? `${(mb2 / 1024).toFixed(3)} GB` : `${mb2.toFixed(3)} MB`;
};
...
const TilesGroupWrapper = qe.div`
	display: flex;
	flex-direction: column;
	align-items: center;
...
function isButtonTileConfig(tile) {
  const valid = typeof tile === "object" && "button" in tile && typeof tile.button === "string" && !!tile.button;
  if (valid) {
...
const Tiles = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    TilesGroup,
    {
      ...
      children: tileComponents.map(
        (tile, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          TileWrapper,
          {
...
const Wrapper = qe.div`
	...
	height: 100%;
	margin: 0;
	background-color: ${(p2) => p2.theme.background};
	font-family: ${(p2) => p2.theme.fontFamily};
	font-size: ${(p2) => p2.theme.fontSize.medium};
	font-weight: ${(p2) => p2.theme.fontWeight.regular};
	color: ${(p2) => p2.theme.text};
`;
const Layout = () => {
...
if ("serviceWorker" in navigator) {
  try {
    navigator.serviceWorker.register(new URL("data:video/mp2t;base64,", import.meta.url)).then((registration) => {
...
ReactDOM.render(/* @__PURE__ */ jsxRuntimeExports.jsx(App, {}), mountNode);
